...
function Hubbard_DMRG(Nsites, t, U, ed)
    ...
    psi0 = randomMPS(sites; linkdims=MAXDIM) #Esse comando de Random_MPS so funciona se conserve_qns = false
    ...
    GS_energy1, GS0 = dmrg(H, psi0; nsweeps, maxdim, cutoff, noise, eigsolve_krylovdim=4, outputlevel=1)
...
#             state = "Up",#Hubbard_DMRG(n, t, U, mu),
